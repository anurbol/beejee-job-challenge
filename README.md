...
**Я сделал как вы и сказали:** реализовал корректное API в духе REST, и кореектная, четкая работа с БД. Считаю данный подход максимально современным, а также в полной мере показывающим мои знания. 
